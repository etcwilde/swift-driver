...
extension Option {
  ...
  public static let emitVariantModuleDocPath: Option = Option("-emit-variant-module-doc-path", .separate, metaVar: "<path>", helpText: "Output module documentation file for the target variant to <path>")
